            ...
            <div className="row">
                <div className="col text-center">
                    ...
                    <p style={{
                        ...
                        Our LP DeepFake System leverages machine learning to accurately detect and identify deepfake videos, ensuring media integrity and trust.
                    </p>
                    <p style={{
                        fontSize: '1.2rem',
                        marginLeft: '20px',
